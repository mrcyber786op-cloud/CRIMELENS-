...
```
    ...
    <div className="max-w-3xl">
      ...
      <p className="mt-2 text-sm text-slate-300 leading-relaxed">
        Professional learning departments for university students,
        law enforcement personnel, private investigators, and legal
        advocates. Master real casework tools through specialized
        webinars, intensive forensic week bootcamps, curated study
      ...
      <div className="mt-8 space-y-6">
        ...
        <div className="p-4 rounded-xl bg-slate-900/60 border border-slate-800 flex items-center justify-between text-xs">
          <span className="text-slate-300">
            ⭐ <strong>CRIMELENS Forensic Weeks</strong> are intensive
            5-day immersive bootcamps with practical virtual labs,
            write-blocked hard drive exercises, and accredited
      ...
      <div className="mt-8 space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4 space-y-2">
            ...
            <div className="mt-4 p-4 rounded-xl bg-slate-900/60 border border-slate-800 text-xs text-slate-300">
              ...
              <p className="text-slate-400 text-[11px] leading-relaxed">
                CRIMELENS pairs university forensic students with
                active casework examiners for mock trial prep and
          ...
          <div className="lg:col-span-8 rounded-xl bg-slate-900/80 border border-slate-800 p-6 space-y-5">
            ...
            <div className="flex flex-col sm:flex-row sm:i                  </div>
